/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1a9a3d4ced036aef600f7d3d68331665)
// Runtime types generated with workerd@1.20251001.0 2025-04-03 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/worker");
    durableNamespaces: "JetstreamConsumer";
  }
  interface Env {
    OAUTH_STORAGE: KVNamespace;
    USE_CACHE: KVNamespace;
    SESSION_SECRET: string;
    JETSTREAM_CONSUMER: DurableObjectNamespace<
      import("./src/worker").JetstreamConsumer
    >;
    DB: D1Database;
  }
}
