/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 76f22771d43290621b8581059f677e4a)
// Runtime types generated with workerd@1.20250924.0 2025-04-03 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/worker");
    durableNamespaces: "PDS" | "RepoStorage" | "FirehoseListener";
  }
  interface Env {
    OAUTH_STORAGE: KVNamespace;
    SESSION_SECRET: string;
    FIREHOSE_LISTENER: DurableObjectNamespace<
      import("./src/worker").FirehoseListener
    >;
    PDS: DurableObjectNamespace<import("./src/worker").PDS>;
    REPO: DurableObjectNamespace<import("./src/worker").RepoStorage>;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<Pick<Cloudflare.Env, "SESSION_SECRET">> {}
}
